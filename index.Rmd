...
group_album_plot1 <- ggplot(group_by_album, aes(x=season, y=tempo, color = season)) + geom_boxplot() + theme(legend.title= element_blank()) + theme_dark()+ ggtitle("Highschool Rapper") +  scale_x_discrete(limits=c("HSR SEASON 1", "HSR SEASON 2", "HSR SEASON 3", "HSR SEASON 4"), labels=c("HSR SEASON 1" = "1", "HSR SEASON 2" = "2", "HSR SEASON 3" = "3", "HSR SEASON 4" = "4"))

group_album_plot2 <- ggplot(group_by_album2, aes(x=season, y=tempo, color =season)) + geom_boxplot() + theme(legend.title= element_blank()) + theme_dark()+ ggtitle("Show me The money") + scale_x_discrete(limits=c("SMTM season 7", "SMTM season 8", "SMTM season 9", "SMTM season 10"), labels=c("SMTM season 7" = "7", "SMTM season 8" = "8", "SMTM season 9" = "9", "SMTM season 10" = "10"))

plot_grid(group_album_plot1, group_album_plot2, heights=c(3,3), nrow=1, ncol=2)
...
plot_grid(TOTAL_plot_valence, TOTAL_plot_energy, labels=c("Valence", "Energy"), hjust="outward", heights=c(3,3), ncol=1, nrow=2)
